...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QueueUnitCondition) DeepCopyInto(out *QueueUnitCondition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QueueUnitCondition.
func (in *QueueUnitCondition) DeepCopy() *QueueUnitCondition {
	if in == nil {
		return nil
	}
	out := new(QueueUnitCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *QueueUnitStatus) DeepCopyInto(out *QueueUnitStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]QueueUnitCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
